...
parser.add_argument('--instruction_and_input',action='store_true', help="write both instruction and input. Can not use with with_prompt")
...
# def generate_prompt_ori(instruction , input ):
...
def generate_prompt(instruction, input=None):
    ...
    temp = prompt_input.format_map({'instruction': instruction})
    return temp
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        if args.interactive:
            ...
            while True:
                if not args.instruction_and_input:
                    ...
                    args.with_prompt = None
                    raw_instruction_text = input("Instruction:")
                    raw_input_text = input("Input:")
                    input_text = generate_prompt_ori(raw_instruction_text ,raw_input_text)
                # print("input_text: \n"+input_text)
                # print("=======================================================================================================")
                ...
                if (args.with_prompt) or (args.instruction_and_input):
